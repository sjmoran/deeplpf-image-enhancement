...
#: The bundled Adobe-DPE model, used when --checkpoint is not given. Present in
#: a git checkout; a wheel installed without it will not find one.
...
def run_enhance(args):
    ...
    net = load_network(checkpoint, device)
