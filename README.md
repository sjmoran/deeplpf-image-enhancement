...
For a step-by-step walkthrough of preparing the Adobe-DPE dataset (Lightroom export settings, the expected folder layout, and helper/verification scripts), see [docs/ADOBE_DPE_DATASET.md](./docs/ADOBE_DPE_DATASET.md).
